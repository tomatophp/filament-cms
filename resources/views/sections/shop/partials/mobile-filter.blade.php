<x-splade-modal slideover name="filter">
    @php
        $loadKeys = [];
        $loadForm = [];
    ...
    <x-splade-form  method="GET" :default="$loadForm" action="{{url()->current()}}" submit-on-change class="mt-16 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg shadow-sm p-4">
